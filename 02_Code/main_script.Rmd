...
ggraph(graph, layout = "auto")+geom_edge_link()+geom_node_label(aes(label =V(graph)$name),label.size =unit(0.1, "lines"),label.padding =unit(.1, "lines"),size = 1.5)+theme_graph(base_family = "Roboto Condensed")

# qgraph(adj, vsize=c(5,10), directed=FALSE, layout='spring', vTrans=50)
...
distance = cDistance(adj, kseq, method = "hierarchical", linkage = "ward.D",
...
cluster_analysis <- fastkmed(adj, ncluster = 50, iterate = 5000)
