...
# data_train <- model.matrix( ~ ., data_train)
# data_test <- model.matrix( ~ ., data_test)

# fitting -----------------------------------------------------------------

# table(data$presenter)

# Set training method to "none" for simple fitting
ctrl_none <- trainControl(method = "none")

grad_glm <- train(form = good_bad ~ id + event + duration + views + likes + dislike + tedx  ,
                  data = data_train,
                  method = "glm",
                  family = "binomial",
                  trControl = ctrl_none,
